...
| Version | Tests | Notes |
|---------|-------|-------|
| v0.18.3 | 10373 | **`--manage-cron` se recompose à la largeur ; audit pathlib-3.14 lot 1** (`/etc/sudoers.d`, `/etc/ssh`, `/etc/cron.d`, `/var/log/journal` — un répertoire refusé se lit non-établi, pas propre). |
