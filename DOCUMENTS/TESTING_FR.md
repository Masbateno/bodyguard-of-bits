...
| Version | Tests | Notes |
|---------|-------|-------|
| v0.15.1 | 7288 | **Une seconde chasse, pour éprouver le résultat de la première — en cours (branche `v0.15.x`).** Angles neufs uniquement : croisement des contrôles qui se recouvrent, ce qu'aucun audit module par module ne peut voir. Porte la passe documentaire reportée de v0.15.0. |
