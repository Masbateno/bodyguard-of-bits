...
- **`--explain KEY`** — explication structurée par constat (POURQUOI / COMMENT CORRIGER / référence CIS) ; 189 clés sur 50 préfixes ; 103 d'entre elles rendent une section par profil — 71 avec une prose écrite pour lui, les autres avec une note dérivée du fichier de profil — et 86 s'appliquent identiquement à tous les profils ; TUI interactif ; sans droit root ; `--explain list` liste toutes les clés
