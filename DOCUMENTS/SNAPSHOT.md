...
│                 7063 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 153 test files, ~4912 functions, 7063 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7063 tests with no mocks.
...
| Tests | 153 test files, ~4912 functions, **7063 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
