...
│                 7095 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 156 test files, ~4942 functions, 7095 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7095 tests with no mocks.
...
| Tests | 156 test files, ~4942 functions, **7095 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
