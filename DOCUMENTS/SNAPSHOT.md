...
│                 7938 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 192 test files, ~5371 functions, 7938 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7938 tests with no mocks.
...
| Tests | 192 test files, ~5371 functions, **7938 collected** (v0.15.3) | `pytest --collect-only -q` |
