...
│                 7130 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 159 test files, ~4969 functions, 7130 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7130 tests with no mocks.
...
| Tests | 159 test files, ~4969 functions, **7130 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
