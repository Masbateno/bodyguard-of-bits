...
│                 7880 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 190 test files, ~5357 functions, 7880 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7880 tests with no mocks.
...
| Tests | 190 test files, ~5357 functions, **7880 collected** (v0.15.3) | `pytest --collect-only -q` |
