...
│                 7548 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 172 test files, ~5206 functions, 7548 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7548 tests with no mocks.
...
| Tests | 172 test files, ~5206 functions, **7548 collected** (v0.15.2) | `pytest --collect-only -q` |
