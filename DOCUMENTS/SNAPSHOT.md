...
│                 6949 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 149 test files, ~4863 functions, 6949 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6949 tests with no mocks.
...
| Tests | 149 test files, ~4863 functions, **6949 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
