...
│                 8041 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 199 test files, ~5436 functions, 8041 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8041 tests with no mocks.
...
| Tests | 199 test files, ~5436 functions, **8041 collected** (v0.15.5) | `pytest --collect-only -q` |
