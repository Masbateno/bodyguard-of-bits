...
│                 7752 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 187 test files, ~5338 functions, 7752 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7752 tests with no mocks.
...
| Tests | 187 test files, ~5338 functions, **7752 collected** (v0.15.3) | `pytest --collect-only -q` |
