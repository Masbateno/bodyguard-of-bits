...
│                 7600 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 176 test files, ~5241 functions, 7600 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7600 tests with no mocks.
...
| Tests | 176 test files, ~5241 functions, **7600 collected** (v0.15.2) | `pytest --collect-only -q` |
