...
│                 6798 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 139 test files, ~4785 functions, 6798 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6798 tests with no mocks.
...
| Tests | 139 test files, ~4785 functions, **6798 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
