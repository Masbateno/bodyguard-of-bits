...
│                 7717 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 183 test files, ~5317 functions, 7717 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7717 tests with no mocks.
...
| Tests | 183 test files, ~5317 functions, **7717 collected** (v0.15.3) | `pytest --collect-only -q` |
