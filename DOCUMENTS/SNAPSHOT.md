...
│                 7104 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 157 test files, ~4951 functions, 7104 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7104 tests with no mocks.
...
| Tests | 157 test files, ~4951 functions, **7104 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
