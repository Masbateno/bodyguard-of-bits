...
│                 9872 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 260 test files, ~6142 functions, 9872 collected (v0.18.0)
...
| Tests | 260 test files, ~6142 functions, **9872 collected** (v0.18.0) | `pytest --collect-only -q` |
