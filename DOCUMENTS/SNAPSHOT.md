...
│                 8134 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 208 test files, ~5520 functions, 8134 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8134 tests with no mocks.
...
| Tests | 208 test files, ~5520 functions, **8134 collected** (v0.15.5) | `pytest --collect-only -q` |
