...
│                 6822 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 141 test files, ~4801 functions, 6822 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6822 tests with no mocks.
...
| Tests | 141 test files, ~4801 functions, **6822 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
