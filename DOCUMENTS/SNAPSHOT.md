...
│                 6866 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 144 test files, ~4827 functions, 6866 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6866 tests with no mocks.
...
| Tests | 144 test files, ~4827 functions, **6866 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
