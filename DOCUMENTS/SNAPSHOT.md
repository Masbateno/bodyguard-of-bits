...
│                 8140 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 208 test files, ~5526 functions, 8140 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8140 tests with no mocks.
...
| Tests | 208 test files, ~5526 functions, **8140 collected** (v0.15.5) | `pytest --collect-only -q` |
