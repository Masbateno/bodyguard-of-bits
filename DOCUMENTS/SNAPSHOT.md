...
│                 6871 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 145 test files, ~4832 functions, 6871 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6871 tests with no mocks.
...
| Tests | 145 test files, ~4832 functions, **6871 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
