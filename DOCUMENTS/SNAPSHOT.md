...
│                 10517 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 287 test files, ~6380 functions, 10517 collected (v0.20.0)
...
| Tests | 287 test files, ~6380 functions, **10517 collected** (v0.20.0) | `pytest --collect-only -q` |
