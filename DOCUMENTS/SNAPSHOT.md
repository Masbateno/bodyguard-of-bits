...
│                 6890 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 146 test files, ~4842 functions, 6890 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6890 tests with no mocks.
...
| Tests | 146 test files, ~4842 functions, **6890 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
