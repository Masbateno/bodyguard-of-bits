...
│                 10178 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 274 test files, ~6240 functions, 10178 collected (v0.18.1)
...
| Tests | 274 test files, ~6240 functions, **10178 collected** (v0.18.1) | `pytest --collect-only -q` |
