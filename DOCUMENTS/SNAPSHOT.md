...
│                 8055 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 200 test files, ~5450 functions, 8055 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8055 tests with no mocks.
...
| Tests | 200 test files, ~5450 functions, **8055 collected** (v0.15.5) | `pytest --collect-only -q` |
