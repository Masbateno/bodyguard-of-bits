...
│                 8117 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 206 test files, ~5509 functions, 8117 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8117 tests with no mocks.
...
| Tests | 206 test files, ~5509 functions, **8117 collected** (v0.15.5) | `pytest --collect-only -q` |
