...
│                 8001 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 196 test files, ~5413 functions, 8001 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8001 tests with no mocks.
...
| Tests | 196 test files, ~5413 functions, **8001 collected** (v0.15.5) | `pytest --collect-only -q` |
