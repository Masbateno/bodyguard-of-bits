...
│                 6905 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 147 test files, ~4846 functions, 6905 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6905 tests with no mocks.
...
| Tests | 147 test files, ~4846 functions, **6905 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
