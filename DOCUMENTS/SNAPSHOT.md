...
│                 8075 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 202 test files, ~5470 functions, 8075 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8075 tests with no mocks.
...
| Tests | 202 test files, ~5470 functions, **8075 collected** (v0.15.5) | `pytest --collect-only -q` |
