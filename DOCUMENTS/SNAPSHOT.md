...
│                 7494 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 171 test files, ~5181 functions, 7494 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7494 tests with no mocks.
...
| Tests | 171 test files, ~5181 functions, **7494 collected** (v0.15.2) | `pytest --collect-only -q` |
