...
│                 6839 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 143 test files, ~4818 functions, 6839 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6839 tests with no mocks.
...
| Tests | 143 test files, ~4818 functions, **6839 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
