...
│                 7575 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 174 test files, ~5227 functions, 7575 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7575 tests with no mocks.
...
| Tests | 174 test files, ~5227 functions, **7575 collected** (v0.15.2) | `pytest --collect-only -q` |
