...
│                 7749 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 186 test files, ~5335 functions, 7749 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7749 tests with no mocks.
...
| Tests | 186 test files, ~5335 functions, **7749 collected** (v0.15.3) | `pytest --collect-only -q` |
