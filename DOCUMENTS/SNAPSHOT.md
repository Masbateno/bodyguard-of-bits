...
│                 8144 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 209 test files, ~5530 functions, 8144 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8144 tests with no mocks.
...
| Tests | 209 test files, ~5530 functions, **8144 collected** (v0.15.5) | `pytest --collect-only -q` |
