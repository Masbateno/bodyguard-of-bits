...
│                 10455 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 283 test files, ~6354 functions, 10455 collected (v0.19.0)
...
| Tests | 283 test files, ~6354 functions, **10455 collected** (v0.19.0) | `pytest --collect-only -q` |
