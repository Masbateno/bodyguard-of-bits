...
│                 7508 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 171 test files, ~5191 functions, 7508 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7508 tests with no mocks.
...
| Tests | 171 test files, ~5191 functions, **7508 collected** (v0.15.2) | `pytest --collect-only -q` |
