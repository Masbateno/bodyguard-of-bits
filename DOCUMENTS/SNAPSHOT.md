...
│                 7981 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 194 test files, ~5396 functions, 7981 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7981 tests with no mocks.
...
| Tests | 194 test files, ~5396 functions, **7981 collected** (v0.15.3) | `pytest --collect-only -q` |
