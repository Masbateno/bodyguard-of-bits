...
│                 7268 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 166 test files, ~5055 functions, 7268 collected (v0.15.0)
...
- **Snapshot + check_xxx separation**. Enables ~7268 tests with no mocks.
...
| Tests | 166 test files, ~5055 functions, **7268 collected** (v0.15.0) | `pytest --collect-only -q` |
