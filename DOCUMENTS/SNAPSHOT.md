...
│                 7261 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 165 test files, ~5051 functions, 7261 collected (v0.15.0)
...
- **Snapshot + check_xxx separation**. Enables ~7261 tests with no mocks.
...
| Tests | 165 test files, ~5051 functions, **7261 collected** (v0.15.0) | `pytest --collect-only -q` |
