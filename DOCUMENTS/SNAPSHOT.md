...
│                 7220 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 163 test files, ~5019 functions, 7220 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7220 tests with no mocks.
...
| Tests | 163 test files, ~5019 functions, **7220 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
