...
│                 10117 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 271 test files, ~6218 functions, 10117 collected (v0.18.1)
...
| Tests | 271 test files, ~6218 functions, **10117 collected** (v0.18.1) | `pytest --collect-only -q` |
