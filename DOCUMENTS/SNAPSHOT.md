...
│                 10187 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 275 test files, ~6245 functions, 10187 collected (v0.18.1)
...
| Tests | 275 test files, ~6245 functions, **10187 collected** (v0.18.1) | `pytest --collect-only -q` |
