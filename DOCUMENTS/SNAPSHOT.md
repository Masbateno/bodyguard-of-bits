...
│                 7029 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 152 test files, ~4892 functions, 7029 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7029 tests with no mocks.
...
| Tests | 152 test files, ~4892 functions, **7029 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
