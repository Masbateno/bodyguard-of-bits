...
│                 10762 unit tests · 23 doc files · 7+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 303 test files, ~6488 functions, 10762 collected (v0.20.5)
...
| Tests | 303 test files, ~6488 functions, **10762 collected** (v0.20.5) | `pytest --collect-only -q` |
