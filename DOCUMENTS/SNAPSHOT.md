...
│                 9959 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 265 test files, ~6170 functions, 9959 collected (v0.18.0)
...
| Tests | 265 test files, ~6170 functions, **9959 collected** (v0.18.0) | `pytest --collect-only -q` |
