...
│                 8147 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
- **Snapshot + check_xxx separation**. Enables ~8147 tests with no mocks.
...
| Tests | 209 test files, ~5530 functions, **8147 collected** (v0.15.5) | `pytest --collect-only -q` |
