...
│                 7560 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 173 test files, ~5218 functions, 7560 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7560 tests with no mocks.
...
| Tests | 173 test files, ~5218 functions, **7560 collected** (v0.15.2) | `pytest --collect-only -q` |
