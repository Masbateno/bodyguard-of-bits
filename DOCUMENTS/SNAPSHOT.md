...
│                 7119 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 158 test files, ~4960 functions, 7119 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7119 tests with no mocks.
...
| Tests | 158 test files, ~4960 functions, **7119 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
