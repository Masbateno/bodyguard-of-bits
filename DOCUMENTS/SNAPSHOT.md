...
│                 7288 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 167 test files, ~5061 functions, 7288 collected (v0.15.0)
...
- **Snapshot + check_xxx separation**. Enables ~7288 tests with no mocks.
...
| Tests | 167 test files, ~5061 functions, **7288 collected** (v0.15.0) | `pytest --collect-only -q` |
