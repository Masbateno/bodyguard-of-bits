...
│                 7179 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 161 test files, ~4996 functions, 7179 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7179 tests with no mocks.
...
| Tests | 161 test files, ~4996 functions, **7179 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
