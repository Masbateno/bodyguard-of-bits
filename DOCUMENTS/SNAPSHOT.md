...
├── tests/                     ← 279 test files, ~6267 functions, 10321 collected (post-v0.18.1)
...
| Tests | 279 test files, ~6267 functions, **10321 collected** (post-v0.18.1) | `pytest --collect-only -q` |
