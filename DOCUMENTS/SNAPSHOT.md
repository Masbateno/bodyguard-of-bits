...
│                 7461 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 171 test files, ~5158 functions, 7461 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7461 tests with no mocks.
...
| Tests | 171 test files, ~5158 functions, **7461 collected** (v0.15.2) | `pytest --collect-only -q` |
