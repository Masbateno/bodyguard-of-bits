...
│                 8101 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 205 test files, ~5494 functions, 8101 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8101 tests with no mocks.
...
| Tests | 205 test files, ~5494 functions, **8101 collected** (v0.15.5) | `pytest --collect-only -q` |
