...
│                 8328 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 219 test files, ~5644 functions, 8328 collected (v0.16.2)
...
| Tests | 219 test files, ~5644 functions, **8328 collected** (v0.16.2) | `pytest --collect-only -q` |
