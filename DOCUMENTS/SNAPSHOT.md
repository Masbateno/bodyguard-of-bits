...
│                 7988 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 195 test files, ~5403 functions, 7988 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~7988 tests with no mocks.
...
| Tests | 195 test files, ~5403 functions, **7988 collected** (v0.15.5) | `pytest --collect-only -q` |
