...
│                 7156 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 160 test files, ~4986 functions, 7156 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7156 tests with no mocks.
...
| Tests | 160 test files, ~4986 functions, **7156 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
