...
│                 6981 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 151 test files, ~4882 functions, 6981 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6981 tests with no mocks.
...
| Tests | 151 test files, ~4882 functions, **6981 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
