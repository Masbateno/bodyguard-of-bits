...
│                 7968 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 193 test files, ~5383 functions, 7968 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7968 tests with no mocks.
...
| Tests | 193 test files, ~5383 functions, **7968 collected** (v0.15.3) | `pytest --collect-only -q` |
