...
│                 10735 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 302 test files, ~6473 functions, 10735 collected (v0.20.4)
...
| Tests | 302 test files, ~6473 functions, **10735 collected** (v0.20.4) | `pytest --collect-only -q` |
