...
│                 7084 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 155 test files, ~4931 functions, 7084 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7084 tests with no mocks.
...
| Tests | 155 test files, ~4931 functions, **7084 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
