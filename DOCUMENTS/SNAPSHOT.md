...
│                 6934 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 148 test files, ~4856 functions, 6934 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6934 tests with no mocks.
...
| Tests | 148 test files, ~4856 functions, **6934 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
