...
│                 7897 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 191 test files, ~5363 functions, 7897 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7897 tests with no mocks.
...
| Tests | 191 test files, ~5363 functions, **7897 collected** (v0.15.3) | `pytest --collect-only -q` |
