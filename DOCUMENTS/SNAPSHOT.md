...
│                 8084 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 203 test files, ~5479 functions, 8084 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8084 tests with no mocks.
...
| Tests | 203 test files, ~5479 functions, **8084 collected** (v0.15.5) | `pytest --collect-only -q` |
