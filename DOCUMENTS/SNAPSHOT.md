...
│                 6964 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 150 test files, ~4876 functions, 6964 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6964 tests with no mocks.
...
| Tests | 150 test files, ~4876 functions, **6964 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
