...
│                 10539 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 289 test files, ~6395 functions, 10569 collected (v0.20.0)
...
| Tests | 289 test files, ~6395 functions, **10569 collected** (v0.20.0) | `pytest --collect-only -q` |
