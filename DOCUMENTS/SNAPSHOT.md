...
│                 10406 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 282 test files, ~6348 functions, 10406 collected (v0.18.3)
...
| Tests | 282 test files, ~6348 functions, **10406 collected** (v0.18.3) | `pytest --collect-only -q` |
