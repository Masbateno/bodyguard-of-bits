...
│                 7865 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 189 test files, ~5351 functions, 7865 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7865 tests with no mocks.
...
| Tests | 189 test files, ~5351 functions, **7865 collected** (v0.15.3) | `pytest --collect-only -q` |
