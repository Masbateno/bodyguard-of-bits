...
│                 7590 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 175 test files, ~5231 functions, 7590 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7590 tests with no mocks.
...
| Tests | 175 test files, ~5231 functions, **7590 collected** (v0.15.2) | `pytest --collect-only -q` |
