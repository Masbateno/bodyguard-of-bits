...
│                 7615 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 177 test files, ~5254 functions, 7615 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7615 tests with no mocks.
...
| Tests | 177 test files, ~5254 functions, **7615 collected** (v0.15.2) | `pytest --collect-only -q` |
