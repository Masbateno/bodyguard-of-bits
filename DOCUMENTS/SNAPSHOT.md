...
│                 8327 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 219 test files, ~5643 functions, 8327 collected (v0.16.2)
...
| Tests | 219 test files, ~5643 functions, **8327 collected** (v0.16.2) | `pytest --collect-only -q` |
