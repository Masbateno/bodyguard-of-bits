...
│                 7707 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 182 test files, ~5311 functions, 7707 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7707 tests with no mocks.
...
| Tests | 182 test files, ~5311 functions, **7707 collected** (v0.15.3) | `pytest --collect-only -q` |
