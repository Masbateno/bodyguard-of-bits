...
│                 10069 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 269 test files, ~6199 functions, 10069 collected (v0.18.1)
...
| Tests | 269 test files, ~6199 functions, **10069 collected** (v0.18.1) | `pytest --collect-only -q` |
