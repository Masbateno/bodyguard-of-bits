...
│                 7754 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 188 test files, ~5348 functions, 7754 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7754 tests with no mocks.
...
| Tests | 188 test files, ~5348 functions, **7754 collected** (v0.15.3) | `pytest --collect-only -q` |
