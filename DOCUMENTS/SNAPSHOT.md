...
│                 7199 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 162 test files, ~5010 functions, 7199 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7199 tests with no mocks.
...
| Tests | 162 test files, ~5010 functions, **7199 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
