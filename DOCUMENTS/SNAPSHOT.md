...
│                 9832 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 259 test files, ~6134 functions, 9832 collected (v0.18.0)
...
| Tests | 259 test files, ~6134 functions, **9832 collected** (v0.18.0) | `pytest --collect-only -q` |
