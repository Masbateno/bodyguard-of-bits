...
├── tests/                     ← 280 test files, ~6267 functions, 10340 collected (post-v0.18.2)
...
| Tests | 280 test files, ~6267 functions, **10340 collected** (post-v0.18.2) | `pytest --collect-only -q` |
