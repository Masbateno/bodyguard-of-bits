...
│                 10138 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 272 test files, ~6226 functions, 10138 collected (v0.18.1)
...
| Tests | 272 test files, ~6226 functions, **10138 collected** (v0.18.1) | `pytest --collect-only -q` |
