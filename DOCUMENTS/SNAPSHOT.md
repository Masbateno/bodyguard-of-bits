...
│                 7394 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 169 test files, ~5145 functions, 7394 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7394 tests with no mocks.
...
| Tests | 169 test files, ~5145 functions, **7394 collected** (v0.15.2) | `pytest --collect-only -q` |
