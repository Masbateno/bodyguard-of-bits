...
│                 6813 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 140 test files, ~4794 functions, 6813 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6813 tests with no mocks.
...
| Tests | 140 test files, ~4794 functions, **6813 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
