...
│                 10373 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 280 test files, ~6267 functions, 10373 collected (v0.18.3)
...
| Tests | 280 test files, ~6267 functions, **10373 collected** (v0.18.3) | `pytest --collect-only -q` |
