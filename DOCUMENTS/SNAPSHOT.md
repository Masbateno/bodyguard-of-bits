...
│                 7500 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 171 test files, ~5187 functions, 7500 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7500 tests with no mocks.
...
| Tests | 171 test files, ~5187 functions, **7500 collected** (v0.15.2) | `pytest --collect-only -q` |
