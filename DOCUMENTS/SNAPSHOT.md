...
4. **doc-version-consistency** — `tests/test_doc_version_consistency.py` (v0.8.0) pins 7 documentation surfaces against `pyproject.toml::version`, so a release cannot ship with a doc still naming the previous version.
