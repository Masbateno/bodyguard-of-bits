...
│                 7231 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 164 test files, ~5026 functions, 7231 collected (v0.15.0)
...
- **Snapshot + check_xxx separation**. Enables ~7231 tests with no mocks.
...
| Tests | 164 test files, ~5026 functions, **7231 collected** (v0.15.0) | `pytest --collect-only -q` |
