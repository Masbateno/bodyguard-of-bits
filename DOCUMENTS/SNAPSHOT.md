...
│                 7420 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 170 test files, ~5153 functions, 7420 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7420 tests with no mocks.
...
| Tests | 170 test files, ~5153 functions, **7420 collected** (v0.15.2) | `pytest --collect-only -q` |
