...
│                 7633 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 178 test files, ~5261 functions, 7633 collected (v0.15.2)
...
- **Snapshot + check_xxx separation**. Enables ~7633 tests with no mocks.
...
| Tests | 178 test files, ~5261 functions, **7633 collected** (v0.15.2) | `pytest --collect-only -q` |
