...
│                 10709 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 300 test files, ~6455 functions, 10709 collected (v0.20.3)
...
| Tests | 300 test files, ~6455 functions, **10709 collected** (v0.20.3) | `pytest --collect-only -q` |
