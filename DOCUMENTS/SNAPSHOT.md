...
│                 7072 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 154 test files, ~4920 functions, 7072 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~7072 tests with no mocks.
...
| Tests | 154 test files, ~4920 functions, **7072 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
