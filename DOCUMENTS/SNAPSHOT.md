...
│                 7974 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 194 test files, ~5389 functions, 7974 collected (v0.15.3)
...
- **Snapshot + check_xxx separation**. Enables ~7974 tests with no mocks.
...
| Tests | 194 test files, ~5389 functions, **7974 collected** (v0.15.3) | `pytest --collect-only -q` |
