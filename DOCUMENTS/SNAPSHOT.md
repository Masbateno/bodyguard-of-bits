...
│                 8454 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 220 test files, ~5665 functions, 8454 collected (v0.16.2)
...
| Tests | 220 test files, ~5665 functions, **8454 collected** (v0.16.2) | `pytest --collect-only -q` |
