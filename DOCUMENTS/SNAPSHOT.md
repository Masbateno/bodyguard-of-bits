...
│                 8069 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 201 test files, ~5464 functions, 8069 collected (v0.15.5)
...
- **Snapshot + check_xxx separation**. Enables ~8069 tests with no mocks.
...
| Tests | 201 test files, ~5464 functions, **8069 collected** (v0.15.5) | `pytest --collect-only -q` |
