...
│                 10165 unit tests · 21 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 273 test files, ~6235 functions, 10165 collected (v0.18.1)
...
| Tests | 273 test files, ~6235 functions, **10165 collected** (v0.18.1) | `pytest --collect-only -q` |
