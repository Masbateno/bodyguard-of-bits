...
│                 10470 unit tests · 23 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 284 test files, ~6365 functions, 10470 collected (v0.19.0)
...
| Tests | 284 test files, ~6365 functions, **10470 collected** (v0.19.0) | `pytest --collect-only -q` |
