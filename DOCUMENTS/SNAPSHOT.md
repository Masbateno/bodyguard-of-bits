...
│                 6826 unit tests · 19 doc files · 5+ distros field-tested │
└─────────────────────────────────────────────────────────────────────────┘
...
├── tests/                     ← 142 test files, ~4805 functions, 6826 collected (v0.15.0-dev)
...
- **Snapshot + check_xxx separation**. Enables ~6826 tests with no mocks.
...
| Tests | 142 test files, ~4805 functions, **6826 collected** (v0.15.0-dev) | `pytest --collect-only -q` |
