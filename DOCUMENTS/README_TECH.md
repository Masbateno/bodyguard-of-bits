...
![Release](https://img.shields.io/badge/version-v0.15.3-brightgreen)
...
- **`--explain KEY`** — structured per-finding explanation (WHY IT IS A RISK / HOW TO FIX / CIS reference); 169 explainable keys across 45 prefixes; 70 keys show profile-specific sections; interactive TUI; no root required; `--explain list` shows all keys
