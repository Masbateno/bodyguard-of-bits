...
![Release](https://img.shields.io/badge/version-v0.5.1-brightgreen)
...
║                           — Bodyguard Of Bits —                              ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  BOB v0.5.1  │  Linux hardening auditor                                      ║
╠══════════════════════════════════════════════════════════════════════════════╣
...
BOB supports the **N and N-2** Python versions, where **N** is the current upstream stable. As of v0.5.1:
