...
| Version | Tests | Notes |
|---------|-------|-------|
| v0.15.1 | 7261 | **A second hunt, to test the first one's result — in progress (branch `v0.15.x`).** New angles only: cross-checking overlapping checks against each other, which no module-by-module audit can see. Carries the documentation pass v0.15.0 deferred. |
