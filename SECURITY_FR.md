...
Les correctifs sortent en `0.17.x+1`. Un breaking change bump le minor (`0.18.0`).

**v0.16.x est en fin de vie le jour où v0.17.0 sort**, selon la politique
« ligne minor la plus récente uniquement » ci-dessus. Aucun correctif de
sécurité ne sera backporté. Les utilisateurs sur v0.16.x doivent
`pipx upgrade bodyguard-of-bits` vers v0.17.x.
